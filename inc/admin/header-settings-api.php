...
function template_theme_settings_init() {
    ...
    add_settings_field(
        ...
        __( 'Цвет фона хедера', 'template_theme' ),
        'template_theme_render_field_colorpicker',
        'template_theme_settings',
        'template_theme_header_logo_section',
        [
            'option_name' => 'template_theme_header_options',
            'field_id'    => 'header_background_color',
...
function template_theme_sanitize_header_options( $input ) {
    ...
    foreach ($text_fields as $tf) {
     ...
     if ( isset( $input['header_background_color'] ) ) {
        $color = sanitize_hex_color( $input['header_background_color'] );
        if ( $color ) {
